    ...
    <>
      ...
      <Section eyebrow="What we can say today" title="The architecture is the guarantee">
        <div className="max-w-3xl space-y-6">
          ...
          <div className="rounded-lg border border-hair bg-surface-1 p-7">
            <h2 className="font-display text-lg font-medium text-ink">Honest compliance posture</h2>
            <p className="mt-2 leading-relaxed text-ink-2">
          ...
          <div className="rounded-lg border border-hair bg-surface-1 p-7">
            <h2 className="font-display text-lg font-medium text-ink">Questions we&apos;ll answer directly</h2>
            <p className="mt-2 leading-relaxed text-ink-2">

...
export default function ConnectPage() {
  return (
    <div className="fixed inset-0 z-[100] bg-navy-900 overflow-auto">
          ...
          {FOUNDERS.map((founder) => (
            ...
            >
              ...
              <a
                ...
                className="mt-4 flex items-center justify-center w-full rounded-xl bg-mint text-navy-900 font-semibold font-display text-[15px] py-3 transition-opacity hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-mint focus-visible:ring-offset-2 focus-visible:ring-offset-navy-900"
              >
